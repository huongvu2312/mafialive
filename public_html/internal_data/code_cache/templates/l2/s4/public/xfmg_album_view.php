<?php
// FROM HASH: 0b326566c1e03dc19eaa74033e60f917
...
<div class="block" data-xf-init="' . ($__vars['canInlineModMediaItems'] ? 'inline-mod' : '') . '" data-type="xfmg_media" data-href="' . $__templater->fn('link', array('inline-mod', ), true) . '">
	...
	$__compilerTemp5 .= '
		...
		'confirmUrl' => $__templater->fn('link', array('media/albums/bookmark', $__vars['album'], ), false),
	), $__vars) . '
...
<div class="block">
	...
	)) . ' ' . $__templater->fn('username_link', array($__vars['album']['User'], false, array(
		'defaultname' => $__vars['album']['username'],
		'class' => 'u-concealed',
	))) . '</li>
								<li>' . $__templater->fontAwesome('fa-clock', array(
		'title' => $__templater->filter('xfmg_date_created', array(array('for_attr', array()),), false),
	)) . ' ' . $__templater->fn('date_dynamic', array($__vars['album']['create_date'], array(
	))) . '</li>
							</ul>
						</div>
					</div>
	...
	$__finalCompiled .= '
			...
			<div class="reactionsBar js-reactionsList ' . ($__vars['album']['reactions'] ? 'is-active' : '') . '">
				' . $__templater->fn('reactions', array($__vars['album'], 'media/albums/reactions', array())) . '
			</div>
