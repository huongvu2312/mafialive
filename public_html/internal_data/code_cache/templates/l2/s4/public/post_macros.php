<?php
// FROM HASH: 424875f3647f5cbd924286c284bf0bbb
return array('macros' => array('post' => function($__templater, array $__arguments, array $__vars)
{
				...
				<div class="message-main uix_messageContent js-quickEditTarget">
					...
					<header class="message-attribution message-attribution--split">
						<div class="message-attribution-main">
							<a href="' . $__templater->fn('link', array('threads/post', $__vars['thread'], array('post_id' => $__vars['post']['post_id'], ), ), true) . '" class="u-concealed"
							   rel="nofollow">
								' . $__templater->fn('date_dynamic', array($__vars['post']['post_date'], array(
	))) . '
							</a>
						</div>
	...
	$__finalCompiled .= '
							<li>
								<a href="' . $__templater->fn('link', array('threads/post', $__vars['thread'], array('post_id' => $__vars['post']['post_id'], ), ), true) . '"
								   data-xf-init="share-tooltip" data-href="' . $__templater->fn('link', array('posts/share', $__vars['post'], ), true) . '"
								   rel="nofollow">
	...
	$__compilerTemp1 .= '
		...
		'confirmUrl' => $__templater->fn('link', array('posts/bookmark', $__vars['post'], ), false),
		'showText' => false,
	), $__vars) . '
									';
	...
	if (!$__vars['hidePosition']) {
		$__finalCompiled .= '
								<li>
									<a href="' . $__templater->fn('link', array('threads/post', $__vars['thread'], array('post_id' => $__vars['post']['post_id'], ), ), true) . '" rel="nofollow">
										#' . $__templater->fn('number', array($__vars['post']['position'] + 1, ), true) . '
									</a>
								</li>
							';
	}
	...
	$__finalCompiled .= '
		...
		'user' => $__vars['post']['User'],
					...
					<div class="reactionsBar js-reactionsList ' . ($__vars['post']['reactions'] ? 'is-active' : '') . '">
						' . $__templater->fn('reactions', array($__vars['post'], 'posts/reactions', array())) . '
					</div>
	...
	if (($__vars['post']['message_state'] == 'deleted') AND $__templater->method($__vars['post'], 'canUndelete', array())) {
		$__compilerTemp4 .= '
												<a href="' . $__templater->fn('link', array('posts/undelete', $__vars['post'], ), true) . '"
...
'post_deleted' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="message message--deleted message--post' . ($__templater->method($__vars['post'], 'isIgnored', array()) ? ' is-ignored' : '') . ($__templater->method($__vars['post'], 'isUnread', array()) ? ' is-unread' : '') . ' js-post js-inlineModContainer"
		...
		'log' => $__vars['post']['DeletionLog'],
						...
						<a href="' . $__templater->fn('link', array('posts/show', $__vars['post'], ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=post-' . $__templater->escape($__vars['post']['post_id']) . ']">' . 'Hiện' . $__vars['xf']['language']['ellipsis'] . '</a>
