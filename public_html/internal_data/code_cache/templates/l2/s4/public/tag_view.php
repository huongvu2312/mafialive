...
';
	$__templater->breadcrumb($__templater->preEscaped('Thẻ'), $__templater->fn('link', array('tags', ), false), array(
	));
	$__finalCompiled .= '
	...
	if ($__vars['modTypes']) {
		...
		if ($__vars['activeModType']) {
			$__finalCompiled .= '
									...
									<a href="' . $__templater->fn('link', array('tags', $__vars['tag'], array('page' => $__vars['page'], ), ), true) . '" class="menu-linkRow">' . 'Tắt' . '</a>
								';
		}
		$__finalCompiled .= '
							</div>
