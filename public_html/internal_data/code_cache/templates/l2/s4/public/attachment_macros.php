...
return array('macros' => array('attachment_list_item' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
		...
		<div class="attachment-details">
			...
			<span class="attachment-details-views">' . 'Xem' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['attachment']['view_count'], array(array('number', array()),), true) . '</span>
		</div>
	</li>
';
