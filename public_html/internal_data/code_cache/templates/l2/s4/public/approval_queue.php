...
<div class="block">
	...
	if ($__vars['filters']['content_type']) {
		$__compilerTemp1 .= '
								<li><a href="' . $__templater->fn('link', array('approval-queue', null, $__templater->filter($__vars['filters'], array(array('replace', array(array('content_type' => null, ), )),), false), ), true) . '"
	...
	if ($__vars['filters']['order'] AND $__vars['sortOrders'][$__vars['filters']['order']]) {
		$__compilerTemp1 .= '
								<li><a href="' . $__templater->fn('link', array('approval-queue', null, $__templater->filter($__vars['filters'], array(array('replace', array(array('order' => null, 'direction' => null, ), )),), false), ), true) . '"
	...
	$__finalCompiled .= '
				...
				<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
					data-href="' . $__templater->fn('link', array('approval-queue/filters', null, $__vars['filters'], ), true) . '"
