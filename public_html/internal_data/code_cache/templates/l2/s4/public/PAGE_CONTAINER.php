<?php
// FROM HASH: ac5d6e278c24836465cfa4c547cdc0ca
...
'canvasNavPanel' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
								<div class="offCanvasMenu-linkHolder u-ripple ' . (($__vars['uix_myAccountLinks'] == 'profile') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="profile" href="' . $__templater->fn('link', array('members', $__vars['xf']['visitor'], ), true) . '" class="offCanvasMenu-link">' . 'Profile' . '</a></div></div>
								<div class="offCanvasMenu-linkHolder u-ripple ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="alerts" href="' . $__templater->fn('link', array('account/alerts', ), true) . '" class="offCanvasMenu-link">' . 'Thông báo' . '</a></div></div>
								<div class="offCanvasMenu-linkHolder u-ripple ' . (($__vars['uix_myAccountLinks'] == 'settings') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="settings" href="' . $__templater->fn('link', array('account/preferences', ), true) . '" class="offCanvasMenu-link">' . 'Thiết lập' . '</a></div></div>
							';
	}
	$__finalCompiled .= '
							';
...
';
	...
	if ($__vars['sidebar']) {
		...
		if ($__templater->fn('property', array('uix_collapsibleSidebar', ), false) AND $__vars['uix_canCollapseSidebar']) {
			$__compilerTemp3 .= '
			<a class="uix_sidebarTrigger__component uix_sidebarTrigger ' . (($__templater->fn('property', array('uix_sidebarTriggerPosition', ), false) == 'sectionLinks') ? 'p-navgroup-link' : 'button') . '" data-xf-init="tooltip" title="' . 'Sidebar' . '">
...
';
	if (!$__templater->fn('property', array('uix_removeWhatsNewButtons', ), false)) {
		$__finalCompiled .= '
';
...
';
	...
	if ($__vars['template'] != 'register_form') {
		$__compilerTemp8 .= '
		';
		if ($__templater->fn('property', array('uix_loginStyle', ), false) != 'link') {
			$__compilerTemp8 .= '
			...
			if ($__templater->method($__vars['xf']['visitor'], 'canStartConversation', array())) {
				$__compilerTemp9 .= '
							<span class="menu-footer-opposite">
								<a href="' . $__templater->fn('link', array('conversations/add', ), true) . '">' . 'Bắt đầu đối thoại mới' . '</a>
							</span>
						';
			}
			$__compilerTemp9 .= '
...
';
	...
	if ($__vars['sidebar']) {
		...
		<div uix_component="MainSidebar" class="p-body-sidebar">
			...
			<div class="uix_sidebarInner ' . (($__templater->fn('property', array('uix_stickySidebar', ), false) == 'top') ? ' uix_stickyBodyElement' : '') . '">
...
';
	...
	if ($__vars['xf']['visitor']['is_admin']) {
		$__compilerTemp23 .= '
														<a href="' . $__templater->fn('base_url', array('admin.php', ), true) . '" target="_blank" class="menu-linkRow">' . 'Admin' . '</a>
													';
	}
	$__compilerTemp23 .= '
													' . '
...
';
	$__compilerTemp29 = '';
	if ($__templater->fn('property', array('uix_stickySidebar', ), false) != 'disabled') {
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__compilerTemp32 .= '
					<ul class="uix_sidebarNavList">
						<li><div class="p-navEl u-ripple ' . (($__vars['uix_myAccountLinks'] == 'profile') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="profile" href="' . $__templater->fn('link', array('members', $__vars['xf']['visitor'], ), true) . '" class="p-navEl-link">' . 'Profile' . '</a></div></div></li>
						<li><div class="p-navEl u-ripple ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="alerts" href="' . $__templater->fn('link', array('account/alerts', ), true) . '" class="p-navEl-link">' . 'Thông báo' . '</a></div></div></li>
						<li><div class="p-navEl u-ripple ' . (($__vars['uix_myAccountLinks'] == 'settings') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="settings" href="' . $__templater->fn('link', array('account/preferences', ), true) . '" class="p-navEl-link">' . 'Thiết lập' . '</a></div></div></li>
					</ul>
				';
	}
	$__compilerTemp33 = '';
...
';
	...
	$__compilerTemp42 .= '
									';
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeStyle', array()) AND (!$__templater->fn('property', array('uix_hideStyleChoose', ), false))) {
		$__compilerTemp42 .= '
										<li><a href="' . $__templater->fn('link', array('misc/style', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . 'Chọn giao diện' . '" rel="nofollow">' . $__templater->escape($__vars['xf']['style']['title']) . '</a></li>
									';
	}
	$__compilerTemp42 .= '
									';
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__compilerTemp42 .= '
										<li><a href="' . $__templater->fn('link', array('misc/language', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . 'Chọn Ngôn ngữ' . '" rel="nofollow"><i class="fa fa-globe" aria-hidden="true"></i> ' . $__templater->escape($__vars['xf']['language']['title']) . '</a></li>
									';
	}
	$__compilerTemp42 .= '
								';
	...
	$__compilerTemp49 .= '
								' . '' . '
							';
	if (strlen(trim($__compilerTemp49)) > 0) {
		$__compilerTemp48 .= '
...
';
	if ($__vars['xf']['visitor'] AND $__templater->method($__vars['xf']['visitor'], 'hasPermission', array('th_uix', 'changeFontSize', ))) {
		$__finalCompiled .= '
    ';
...
<html id="XF" lang="' . $__templater->escape($__vars['xf']['language']['language_code']) . '" dir="' . $__templater->escape($__vars['xf']['language']['text_direction']) . '"
	...
	$__finalCompiled .= '
					...
					';
	if ((!$__templater->fn('property', array('uix_navAboveHeader', ), false))) {
		$__finalCompiled .= '
	...
	$__vars['navHtml'] = $__templater->preEscaped('
		...
		'content' => $__vars['uix_search__component'],
							...
							' . $__templater->callMacro('uix_megaMenu', 'uix_megaMenu', array(), $__vars) . '
						</nav>
					');
	$__finalCompiled .= '
	...
	if ($__vars['sideNav']) {
		$__finalCompiled .= '
			...
			'data-menu' => '#js-SideNavOcm',
										...
										<div class="p-body-sideNavInner ' . (($__templater->fn('property', array('uix_stickySidebar', ), false) == 'top') ? ' uix_stickyBodyElement' : '') . '" data-ocm-class="offCanvasMenu offCanvasMenu--blocks" id="js-SideNavOcm" data-ocm-builder="sideNav">
											<div class="uix_sidebar--scroller">
	...
	$__finalCompiled .= '
		...
		'insideContent' => $__templater->fn('property', array('uix_footerInsideContent', ), false),
	), $__vars) . '
					</div>
				</div>
	...
	if ($__templater->fn('property', array('uix_fab', ), false) != 'never') {
		$__compilerTemp59 .= '
								';
		$__compilerTemp60 = '';
		$__compilerTemp60 .= (isset($__templater->pageParams['pageAction']) ? $__templater->pageParams['pageAction'] : '');
		if (strlen(trim($__compilerTemp60)) > 0) {
			$__compilerTemp59 .= '
									<div class="p-title-pageAction">' . $__compilerTemp60 . '</div>
								';
		}
		$__compilerTemp59 .= '
							';
	...
	if (($__templater->fn('property', array('uix_fab', ), false) != 'never') AND (!$__templater->fn('property', array('uix_fabScroll', ), false))) {
		$__finalCompiled .= '
					';
		$__compilerTemp61 = '';
		$__compilerTemp61 .= (isset($__templater->pageParams['pageAction']) ? $__templater->pageParams['pageAction'] : '');
		if (strlen(trim($__compilerTemp61)) > 0) {
			$__finalCompiled .= '
						<div class="uix_fabBar uix_fabBar--mirror">
							<div class="p-title-pageAction">' . $__compilerTemp61 . '</div>
						</div>
					';
		}
		$__finalCompiled .= '
		...
		$__finalCompiled .= '
			<div class="uix__loginForm uix__loginForm--login">
				<div class="uix__loginForm--panel">
					';
		$__compilerTemp62 = $__vars;
		$__compilerTemp62['uix_loginPreventAutoFocus'] = '1';
		$__finalCompiled .= $__templater->includeTemplate('login', $__compilerTemp62) . '
				</div>
