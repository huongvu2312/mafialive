...
{
	$__finalCompiled = '';
	$__finalCompiled .= 'Your thread ' . ($__templater->fn('prefix', array('thread', $__vars['extra']['prefix_id'], 'plain', ), true) . $__templater->escape($__vars['extra']['title'])) . ' was moved to a different forum.' . '
';
