...
' . $__templater->filter($__vars['html'], array(array('raw', array()),), true) . '
		...
		<tr>
			<td class="footer" align="center" valign="top">
				<div>' . '<a href="' . $__templater->fn('link', array('canonical:index', ), true) . '">Ghé thăm ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '</a>' . '</div>
...
' . 'Ghé thăm ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ': ' . $__templater->fn('link', array('canonical:index', ), true) . '' . '
