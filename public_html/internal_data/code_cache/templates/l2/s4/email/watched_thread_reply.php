...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . '' . ($__templater->fn('prefix', array('thread', $__vars['thread'], 'escaped', ), true) . $__templater->escape($__vars['thread']['title'])) . ' - Phản hồi mới cho chủ đề được theo dõi' . '
</mail:subject>

' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->fn('username_link_email', array($__vars['post']['User'], $__vars['post']['username'], ), true) . ' đã trả lời vào chủ đề bạn đang xem tại ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
