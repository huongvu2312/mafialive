...
'uploaded_file' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['attachment']['has_thumbnail']) {
		$__finalCompiled .= '
					<a href="' . $__templater->fn('link', array('attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true) . '" target="_blank">
						<img src="' . $__templater->fn('base_url', array($__vars['attachment']['thumbnail_url'], ), true) . '" class="js-attachmentThumb" alt="' . $__templater->escape($__vars['attachment']['filename']) . '" />
					</a>
				';
		...
		$__finalCompiled .= '
					<a href="' . $__templater->escape($__vars['attachment']['video_url']) . '" target="_blank">
						<video data-xf-init="video-init">
							<source src="' . $__templater->fn('base_url', array($__vars['attachment']['video_url'], ), true) . '" />
	...
	$__finalCompiled .= '
				<div class="contentRow-title">
					<a href="' . ($__vars['attachment']['is_video'] ? $__templater->escape($__vars['attachment']['video_url']) : $__templater->fn('link', array('attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true)) . '" class="js-attachmentView" target="_blank">' . $__templater->escape($__vars['attachment']['filename']) . '</a>
				</div>
				';
		...
		<li class="js-attachmentFile" ' . $__templater->fn('mustache', array('#attachment_id', 'data-attachment-id="{{attachment_id}}"', ), true) . '>
			<div class="contentRow">
				<span class="contentRow-figure attachUploadList-figure">
					...
					')) . '
					' . $__templater->fn('mustache', array('^thumbnail_url', '
						' . $__templater->fn('mustache', array('#is_video', '
							<a href="' . $__templater->fn('mustache', array('video_url', ), true) . '" target="_blank">
								<video data-xf-init="video-init">
									<source src="' . $__templater->fn('mustache', array('video_url', ), true) . '" />
									<i class="attachUploadList-placeholder" aria-hidden="true"></i>
								</video>
							</a>
						')) . '
