<?php
// FROM HASH: f80845c3cab7013e9158f2af1dc471c7
...
<div class="block">
	...
	if ($__vars['label']) {
		$__compilerTemp1 .= '
								<li><a href="' . $__templater->fn('link', array('account/bookmarks', ), true) . '"
	...
	$__finalCompiled .= '
		...
		'class' => 'button--primary',
						...
						', array(
		'action' => $__templater->fn('link', array('account/bookmarks', ), false),
	)) . '
					</div>
				</div>
			</div>
