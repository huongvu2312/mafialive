...
' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->escape($__vars['sender']['username']) . ' added you to an existing personal conversation at ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
...
<tr>
	<td>
		<a href="' . $__templater->fn('link', array('canonical:conversations', $__vars['conversation'], ), true) . '" class="button">' . 'Xem cuộc trò chuyện này' . '</a>
	</td>
