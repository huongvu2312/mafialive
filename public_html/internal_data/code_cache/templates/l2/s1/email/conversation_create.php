...
' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->escape($__vars['sender']['username']) . ' bắt đầu một cuộc trò chuyện cá nhân mới với bạn tại ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
