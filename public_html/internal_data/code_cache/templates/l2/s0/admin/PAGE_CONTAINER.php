<?php
// FROM HASH: 39fbe00eb5a7e52df89ffc04dd04db99
...
<header class="p-header">
	<div class="p-header-buttons p-header-buttons--main">
		...
		<a href="' . $__templater->fn('link', array('index', ), true) . '" class="p-header-button" aria-label="' . $__templater->filter('Trang chủ', array(array('for_attr', array()),), true) . '">' . $__templater->fontAwesome('fa-home', array(
	)) . '</a>
	...
	if ($__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('option', ))) {
		$__finalCompiled .= '
			...
			<div class="menu menu--structural menu--superWide" data-menu="menu" aria-hidden="true"
				data-href="' . $__templater->fn('link', array('options/menu', ), true) . '"
	...
	$__finalCompiled .= '
		...
		<form action="' . $__templater->fn('link', array('search/search', ), true) . '" class="menu menu--structural menu--veryWide" data-xf-init="admin-search" data-menu="menu" aria-hidden="true">
