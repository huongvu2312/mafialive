...
';
	...
	<div class="buttonGroup">
		...
		'href' => $__templater->fn('link', array('reactions/sort', ), false),
		'icon' => 'sort',
		'overlay' => 'true',
	), '', array(
	)) . '
...
,array(
	...
	<div class="block-container">
		...
		<div class="block-footer block-footer--split">
			<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__templater->method($__vars['reactions'], 'count', array()), ), true) . '</span>
		</div>
	</div>
', array(
		'action' => $__templater->fn('link', array('reactions/toggle', ), false),
		'ajax' => 'true',
		'class' => 'block',
	));
