		...
		<ul class="tabPanes">
			...
			<li role="tabpanel" id="' . $__templater->fn('unique_id', array('regAssoc', ), true) . '">
				<div class="block-body block-row">
					' . 'Để liên kết với tài khoản sẵn có, bạn phải đăng nhập vào tài khoản đó trước và bắt đầu quá trình liên kết tại <a href="' . $__templater->fn('link', array('account/connected-accounts', ), true) . '">khu vực tài khoản liên kết</a>.' . '
				</div>
			</li>
		</ul>
	</div>
