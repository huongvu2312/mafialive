...
'results' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
		...
		if ($__vars['xf']['visitor']['user_id'] AND ($__vars['findNew']['filters']['unread'] AND ($__templater->fn('count', array($__vars['findNew']['filters'], ), false) == 1))) {
			$__finalCompiled .= '
				' . 'Bạn không có bài viết chưa đọc. Thay vào đó, bạn có thể <a href="' . $__templater->fn('link', array($__vars['latestRoute'], null, array('skip' => 1, ), ), true) . '" rel="nofollow">xem tất cả các bài đăng mới nhất</a>.' . '
			';
		} else {
			$__finalCompiled .= '
				' . 'Không tìm thấy.' . '
