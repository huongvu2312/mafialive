...
<p><a href="' . $__templater->fn('link', array('canonical:account-confirmation/email', $__vars['user'], array('c' => $__vars['confirmation']['confirmation_key'], ), ), true) . '" class="button">' . 'Xác nhận thư điện tử của bạn' . '</a></p>';
