...
{
	$__finalCompiled = '';
	$__finalCompiled .= '' . ($__templater->escape($__vars['user']['username']) ?: $__templater->escape($__vars['alert']['username'])) . ' đã tương tác với bạn trong chủ đề ' . ($__templater->fn('prefix', array('thread', $__vars['content']['Thread'], 'plain', ), true) . $__templater->escape($__vars['content']['Thread']['title'])) . ' với biểu cảm ' . $__templater->fn('reaction_title', array($__vars['extra']['reaction_id'], ), true) . '.' . '
