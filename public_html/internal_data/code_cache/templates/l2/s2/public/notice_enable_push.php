...
<div data-xf-init="push-cta">
	<div class="u-alignCenter">
		<div class="js-initialMessage">
			' . '' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ' cần bạn cho phép để <a href="' . $__templater->fn('link', array('account/preferences', ), true) . '" class="js-enablePushLink">gửi thông báo</a>.' . '
		</div>
		<div class="js-dismissMessage" style="display: none">
			...
			<ul class="listInline listInline--bullet" style="margin-top: 5px">
				<li><a href="' . $__templater->fn('link', array('account/preferences', ), true) . '" class="js-enablePushLink">' . 'Enable notifications' . '</a></li>
