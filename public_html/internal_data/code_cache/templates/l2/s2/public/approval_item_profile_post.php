...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'messageHtml' => $__templater->fn('bb_code', array($__vars['content']['message'], 'profile_post', $__vars['content'], ), false),
		'typePhraseHtml' => 'Profile Post',
		'spamDetails' => $__vars['spamDetails'],
		'unapprovedItem' => $__vars['unapprovedItem'],
		'handler' => $__vars['handler'],
		'headerPhraseHtml' => 'Posted on profile <a href="' . $__templater->fn('link', array('profile-posts', $__vars['content'], ), false) . '">' . $__vars['content']['ProfileUser']['username'] . '</a>',
	), $__vars);
