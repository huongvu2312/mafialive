...
';
		...
		$__finalCompiled .= '
	' . '' . $__templater->fn('username_link', array($__vars['user'], false, array('defaultname' => $__vars['alert']['username'], ), ), true) . ' bình luận trong <a ' . (('href="' . $__templater->fn('link', array('profile-posts/comments', $__vars['content'], ), true)) . '" class="fauxBlockLink-blockLink"') . '>bài đăng của ' . $__templater->escape($__vars['content']['ProfilePost']['username']) . '</a> trong hồ sơ của bạn.' . '
';
	}
