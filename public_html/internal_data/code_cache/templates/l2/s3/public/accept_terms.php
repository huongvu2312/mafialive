...
<div class="blockMessage blockMessage--iconic blockMessage--important">
	' . 'Please read and accept our terms and rules before continuing.' . ' ' . 'Cập nhật lần cuối' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('date_dynamic', array($__vars['xf']['options']['termsLastUpdate'], array(
	))) . '.
</div>
...
', array(
		'action' => $__templater->fn('link', array('misc/accept-terms', ), false),
		'ajax' => 'true',
		'class' => 'block',
