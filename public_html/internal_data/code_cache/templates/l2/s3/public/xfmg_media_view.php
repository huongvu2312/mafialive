<?php
// FROM HASH: 1836bf226826716cd487db1aa3cd4325
...
' . $__templater->callMacro('metadata_macros', 'metadata', array(
		...
		'shareUrl' => $__templater->fn('link', array('canonical:media', $__vars['mediaItem'], ), false),
		'imageUrl' => $__templater->method($__vars['mediaItem'], 'getCurrentThumbnailUrl', array(true, )),
		'canonicalUrl' => $__templater->fn('link', array('canonical:media', $__vars['mediaItem'], array('page' => $__vars['page'], ), ), false),
	), $__vars) . '
...
<div class="media">
	...
	if ($__vars['filmStripParams']['prevItem']) {
		$__finalCompiled .= '
		<a href="' . $__templater->fn('link', array('media', $__vars['filmStripParams']['prevItem'], ), true) . '" class="media-button media-button--prev" data-xf-key="ArrowLeft"><i class="media-button-icon"></i></a>
	';
	}
	$__finalCompiled .= '
	...
	<div class="media-container"
		...
		data-edit-url="' . $__templater->fn('link', array('media/note-edit', $__vars['mediaItem'], ), true) . '">
	...
	if ($__vars['filmStripParams']['nextItem']) {
		$__finalCompiled .= '
		<a href="' . $__templater->fn('link', array('media', $__vars['filmStripParams']['nextItem'], ), true) . '" class="media-button media-button--next" data-xf-key="ArrowRight"><i class="media-button-icon"></i></a>
	';
	}
	$__finalCompiled .= '
</div>
...
<div class="block js-mediaInfoBlock">
			...
			<div class="xfmgInfoBlock-title">
				<div class="contentRow contentRow--alignMiddle">
					<span class="contentRow-figure">
						' . $__templater->fn('avatar', array($__vars['mediaItem']['User'], 's', false, array(
		'defaultname' => $__vars['mediaItem']['username'],
	))) . '
					</span>
					<div class="contentRow-main">
						<h1 class="contentRow-title p-title-value">' . $__templater->fn('page_h1', array('')) . '</h1>
	...
	)) . ' ' . $__templater->fn('username_link', array($__vars['mediaItem']['User'], false, array(
		'defaultname' => $__vars['mediaItem']['username'],
		'class' => 'u-concealed',
	))) . '</li>
								<li>' . $__templater->fontAwesome('fa-clock', array(
		'title' => $__templater->filter('xfmg_date_added', array(array('for_attr', array()),), false),
	)) . ' ' . $__templater->fn('date_dynamic', array($__vars['mediaItem']['media_date'], array(
	))) . '</li>
								';
	if ($__vars['xf']['options']['enableTagging'] AND ($__templater->method($__vars['mediaItem'], 'canEditTags', array()) OR $__vars['mediaItem']['tags'])) {
		$__finalCompiled .= '
			...
			'editLink' => ($__templater->method($__vars['mediaItem'], 'canEditTags', array()) ? $__templater->fn('link', array('media/tags', $__vars['mediaItem'], ), false) : ''),
		), $__vars) . '
									</li>
								';
	}
					...
					<div class="bbCodeBlock bbCodeBlock--expandable">
						<div class="bbCodeBlock-content">
							<div class="bbCodeBlock-expandContent">
								' . $__templater->fn('structured_text', array($__vars['mediaItem']['description'], ), true) . '
							</div>
	...
	$__finalCompiled .= '
		...
		'set' => $__vars['mediaItem']['custom_fields'],
			...
			<div class="reactionsBar js-reactionsList ' . ($__vars['mediaItem']['reactions'] ? 'is-active' : '') . '">
				' . $__templater->fn('reactions', array($__vars['mediaItem'], 'media/reactions', array())) . '
			</div>
	...
	$__compilerTemp2 = '';
	$__compilerTemp2 .= '
									' . $__templater->fn('react', array(array(
	...
	if ($__templater->method($__vars['mediaItem'], 'canReport', array())) {
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('media/report', $__vars['mediaItem'], ), true) . '"
	...
	if ($__templater->method($__vars['mediaItem'], 'canEdit', array())) {
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('media/edit', $__vars['mediaItem'], ), true) . '"
	...
	if ($__templater->method($__vars['mediaItem'], 'canDelete', array())) {
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('media/delete', $__vars['mediaItem'], ), true) . '"
	...
	if ($__templater->method($__vars['mediaItem'], 'canCleanSpam', array())) {
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('spam-cleaner', $__vars['mediaItem'], ), true) . '"
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewIps', array()) AND $__vars['mediaItem']['ip_id']) {
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('media/ip', $__vars['mediaItem'], ), true) . '"
	...
	if ($__templater->method($__vars['mediaItem'], 'canWarn', array())) {
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('media/warn', $__vars['mediaItem'], ), true) . '"
		...
		$__compilerTemp3 .= '
										<a href="' . $__templater->fn('link', array('warnings', array('warning_id' => $__vars['mediaItem']['warning_id'], ), ), true) . '"
	...
	if ($__templater->method($__vars['mediaItem'], 'canRate', array())) {
		$__compilerTemp4 .= '
						' . $__templater->button('
							' . 'Leave a rating' . '
						', array(
			'href' => $__templater->fn('link', array('media/media-ratings/rate', $__vars['mediaItem'], ), false),
			'overlay' => 'true',
		), '', array(
		)) . '
					';
	...
	if ($__templater->method($__vars['mediaItem'], 'canUndelete', array()) AND ($__vars['mediaItem']['media_state'] == 'deleted')) {
		$__compilerTemp5 .= '
									' . $__templater->button('
										' . 'Undelete' . '
									', array(
			'href' => $__templater->fn('link', array('media/undelete', $__vars['mediaItem'], ), false),
			'class' => 'button--link',
			'overlay' => 'true',
		), '', array(
		)) . '
	...
	if ($__templater->method($__vars['mediaItem'], 'canApproveUnapprove', array()) AND ($__vars['mediaItem']['media_state'] == 'moderated')) {
		$__compilerTemp5 .= '
									' . $__templater->button('
										' . 'Duyệt bài' . '
									', array(
			'href' => $__templater->fn('link', array('media/approve', $__vars['mediaItem'], ), false),
			'class' => 'button--link',
			'overlay' => 'true',
		), '', array(
		)) . '
	...
	if ($__templater->method($__vars['mediaItem'], 'canWatch', array())) {
		...
		$__compilerTemp5 .= $__templater->button('
										...
										' . $__compilerTemp6 . '
									', array(
			'href' => $__templater->fn('link', array('media/watch', $__vars['mediaItem'], ), false),
			'class' => 'button--link',
	...
	$__compilerTemp5 .= '
		...
		'content' => $__vars['mediaItem'],
		'confirmUrl' => $__templater->fn('link', array('media/bookmark', $__vars['mediaItem'], ), false),
	), $__vars) . '
	...
	if ($__templater->method($__vars['mediaItem'], 'canSetAsAvatar', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->fn('link', array('media/set-as-avatar', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">
															' . 'xfmg_set_as_avatar' . '
														</a>
														';
		if ($__vars['avatarUpdated']) {
			$__compilerTemp7 .= '
															<a href="' . $__templater->fn('link', array('account/avatar', ), true) . '" data-xf-click="overlay" data-load-auto-click="true" style="display: none"></a>
														';
		}
		$__compilerTemp7 .= '
													';
	...
	if ($__templater->method($__vars['mediaItem'], 'canEdit', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->fn('link', array('media/edit', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'xfmg_edit_media_item' . '</a>
													';
	}
	$__compilerTemp7 .= '
													';
	if ($__templater->method($__vars['mediaItem'], 'canEditImage', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->fn('link', array('media/edit-image', $__vars['mediaItem'], ), true) . '" class="menu-linkRow">' . 'xfmg_edit_image' . '</a>
													';
	}
	$__compilerTemp7 .= '
													';
	if ($__templater->method($__vars['mediaItem'], 'canChangeThumbnail', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->fn('link', array('media/change-thumbnail', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'xfmg_change_thumbnail' . '</a>
													';
	}
	$__compilerTemp7 .= '
													';
	if ($__templater->method($__vars['mediaItem'], 'canMove', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->fn('link', array('media/move', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'xfmg_move_media_item' . '</a>
													';
	}
	$__compilerTemp7 .= '
													';
	if ($__templater->method($__vars['mediaItem'], 'canDelete', array('soft', ))) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->fn('link', array('media/delete', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'xfmg_delete_media_item' . '</a>
													';
	}
	$__compilerTemp7 .= '
													' . '
