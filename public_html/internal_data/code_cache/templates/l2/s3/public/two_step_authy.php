...
<br />If you do not, or cannot, receive the notification, you may <a href="' . $__templater->fn('link', array('logout', null, array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '">log out</a> or try another method.' . '
