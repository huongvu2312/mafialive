...
[EMAIL=example@example.com]Email me[/EMAIL]', array(array('preEscaped', array()),), false),
		...
		'example' => $__templater->filter('[USER=' . ($__vars['xf']['visitor']['user_id'] ? $__vars['xf']['visitor']['user_id'] : '1') . ']' . ($__vars['xf']['visitor']['user_id'] ? $__vars['xf']['visitor']['username'] : 'Tên tài khoản') . '[/USER]', array(array('preEscaped', array()),), false),
		'anchor' => 'user-mention',
	), $__vars) . '
		...
		'anchor' => 'image',
			...
			<li class="bbCodeHelpItem block-row block-row--separated">
				...
				<div>
					...
					' . 'Trang được cho phép' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('media_sites', array(), true) . '
				</div>
				<div class="bbCodeDemoBlock">
					<dl class="bbCodeDemoBlock-item">
						<dt>' . 'Ví dụ' . $__vars['xf']['language']['label_separator'] . '</dt>
