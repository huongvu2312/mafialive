<?php
// FROM HASH: 598cafebad4820c1c90ad1ee153668e7
return array('macros' => array('comment' => function($__templater, array $__arguments, array $__vars)
{
	...
	<article class="message message--depth' . $__templater->escape($__vars['post']['depth']) . ' message--simple' . ($__templater->method($__vars['post'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-inlineModContainer"
	...
	$__finalCompiled .= '
						...
						<header class="message-attribution message-attribution--plain">
							<ul class="listInline listInline--bullet">
								<li class="message-attribution-user">
									' . $__templater->fn('avatar', array($__vars['post']['User'], 'xxs', false, array(
	))) . '
		...
		'showTargetUser' => $__vars['showTargetUser'],
								...
								<li><a href="' . $__templater->fn('link', array('posts', $__vars['post'], ), true) . '"
									   class="u-concealed"
									   rel="nofollow">
	...
	if ($__templater->method($__vars['post'], 'canLike', array())) {
		$__compilerTemp1 .= '
											<a href="' . $__templater->fn('link', array('posts/like', $__vars['post'], ), true) . '"
	...
	if ($__templater->method($__vars['post'], 'canComment', array())) {
		$__compilerTemp1 .= '
											<a href="' . $__templater->fn('link', array('posts/comment', $__vars['post'], ), true) . '"
