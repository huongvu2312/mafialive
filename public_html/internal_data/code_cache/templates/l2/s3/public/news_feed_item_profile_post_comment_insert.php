...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . '' . $__templater->fn('username_link', array($__vars['user'], false, array('defaultname' => $__vars['newsFeed']['username'], ), ), true) . ' đã bình luận trên bài viết của ' . (((('<a href="' . $__templater->fn('link', array('profile-posts/comments', $__vars['content'], ), true)) . '">') . $__templater->escape($__vars['content']['ProfilePost']['username'])) . '</a>') . '.' . '
</div>
