	...
	';
			...
			foreach ($__vars['styles'] AS $__vars['style']) {
				...
				if ($__vars['style']['installed']) {
					$__compilerTemp2[] = array(
						...
						'href' => $__templater->fn('link', array('styles/themehouse/child-styles', null, array('product_id' => $__vars['style']['id'], 'style_id' => $__vars['style']['installed']['style_id'], ), ), false),
						'_type' => 'cell',
						'html' => 'Child styles',
					);
					if ($__vars['style']['isOutdated']) {
						$__compilerTemp2[] = array(
							...
							'href' => $__templater->fn('link', array('styles/themehouse/upgrade', null, array('product_id' => $__vars['style']['id'], 'style_id' => $__vars['style']['installed']['style_id'], ), ), false),
							'_type' => 'cell',
							'html' => 'Upgrade',
						);
					} else {
					...
					$__compilerTemp2[] = array(
						...
						'href' => $__templater->fn('link', array('styles/themehouse/install', null, array('product_id' => $__vars['style']['id'], ), ), false),
						'_type' => 'cell',
						'html' => 'Install',
					);
				}
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="u-pullRight">' . 'Showing ' . $__templater->fn('count', array($__vars['styles'], ), true) . ' of ' . $__templater->fn('count', array($__vars['styles'], ), true) . ' items' . '</span>
			</div>
		</div>
	', array(
			'action' => $__templater->fn('link', array('styles/themehouse', ), false),
			'class' => 'block',
		)) . '
	';
	} else {
