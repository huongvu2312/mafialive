	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				<span class="collapseTrigger collapseTrigger--block ' . ((!$__templater->fn('is_toggled', array('collapse_env_report', ), false)) ? 'is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-key="collapse_env_report" data-target="#js-collapse-env-report">
		...
		if ($__vars['envReport']['phpVersionState'] == 'minimum') {
			...
			$__finalCompiled .= '
					<div class="block-rowMessage block-rowMessage--warning">
						' . 'Your version of PHP may not support all of XenForo features. We recommend PHP 7.1 or higher.' . '
					</div>
				';
...
';
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				<span class="collapseTrigger collapseTrigger--block ' . ((!$__templater->fn('is_toggled', array('collapse_logged_activity', ), false)) ? 'is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-key="collapse_logged_activity" data-target="#js-collapse-logged-activity">
					' . 'Logged activity' . '
				</span>
			</h2>
...
';
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				<span class="collapseTrigger collapseTrigger--block ' . ((!$__templater->fn('is_toggled', array('collapse_staff_online', ), false)) ? 'is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-key="collapse_staff_online" data-target="#js-collapse-staff-online">
					' . 'Staff online' . '
				</span>
			</h2>
...
';
	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				<span class="collapseTrigger collapseTrigger--block ' . ((!$__templater->fn('is_toggled', array('collapse_health_check', ), false)) ? 'is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-key="collapse_health_check" data-target="#js-collapse-health-check">
...
';
	...
	<div class="addOnList">
		<div class="block">
			<div class="block-container">
				<h2 class="block-header">
					<span class="collapseTrigger collapseTrigger--block ' . ((!$__templater->fn('is_toggled', array('collapse_add_ons', ), false)) ? 'is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-key="collapse_add_ons" data-target="#js-collapse-add-ons">
						' . 'Installed add-ons' . '
					</span>
				</h2>
