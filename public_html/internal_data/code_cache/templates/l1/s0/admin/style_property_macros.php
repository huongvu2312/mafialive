...
'property_edit_value' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
	$__vars['titleHtml'] = $__templater->preEscaped('<span class="u-anchorTarget" id="sp-' . $__templater->escape($__vars['property']['property_name']) . '"></span>' . $__templater->fn('uix_style_property_prefix', array($__vars['property'], ), true) . $__templater->escape($__vars['property']['title']));
	$__finalCompiled .= '
	...
	if ($__vars['property']['property_type'] !== 'css') {
		$__compilerTemp1 .= '
			' . $__templater->fn('uix_style_property_documentation', array($__vars['property'], ), true) . '
		';
	}
	$__compilerTemp2 = '';
...
'property_edit_css' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="cssPropertyWrapper" data-toggle-wrapper="1">
		...
		'property' => $__vars['property'],
				...
				<span class="u-anchorTarget" id="sp-' . $__templater->escape($__vars['property']['property_name']) . '"></span><span>' . $__templater->fn('uix_style_property_prefix', array($__vars['property'], ), true) . $__templater->escape($__vars['property']['title']) . '</span>
				';
