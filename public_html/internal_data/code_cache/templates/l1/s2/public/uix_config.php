...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	window.themehouse.settings = {
		...
		sidebar: {
			...
			link: \'' . $__templater->fn('link', array('uix/toggle-sidebar.json', null, array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '\',
            state: \'' . $__templater->escape($__vars['uix_sidebarCollapsed']) . '\',
		},
        sidebarNav: {
            enabled: \'' . $__templater->escape($__vars['uix_canCollapseSidebarNav']) . '\',
			link: \'' . $__templater->fn('link', array('uix/toggle-sidebar-navigation.json', null, array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '\',
        ...
        nodesCollapse: {
			...
			link: \'' . $__templater->fn('link', array('uix/toggle-category.json', null, array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '\',
			state: \'' . $__templater->escape($__vars['uix_collapsedCategoriesJson']) . '\',
        },
		widthToggle: {
			enabled: \'' . $__templater->escape($__vars['uix_canTogglePageWidth']) . '\',
			link: \'' . $__templater->fn('link', array('uix/toggle-width.json', null, array('t' => $__templater->fn('csrf_token', array(), false), ), ), true) . '\',
