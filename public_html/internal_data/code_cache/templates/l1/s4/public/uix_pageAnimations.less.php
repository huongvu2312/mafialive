<?php
// FROM HASH: e223083300130b3f38ea2a916375c049
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= '@media (min-width: @xf-responsiveWide) {
		...
		';
	if ($__templater->fn('property', array('uix_pageAnimation', ), false)) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
		...
		';
	if ($__templater->fn('property', array('uix_nodeAnimations', ), false)) {
		$__finalCompiled .= '
		.block--category {
			.uix_nodeLoop(15);
		}
	...
	$__finalCompiled .= '
		...
		';
	if ($__templater->fn('property', array('uix_sideNavigationAnimation', ), false)) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
		...
		';
	if ($__templater->fn('property', array('uix_sidebarWidgetAnimations', ), false)) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
		...
		';
	if ($__templater->fn('property', array('uix_discussionListAnimation', ), false)) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
		...
		';
	if ($__templater->fn('property', array('uix_messageAnimation', ), false)) {
		$__finalCompiled .= '
