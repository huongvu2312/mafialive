<?php
// FROM HASH: cde8e4c22b460eba1f8134f45bde0cf2
return array('macros' => array('resource_update' => function($__templater, array $__arguments, array $__vars)
{
					...
					<div class="message-content js-messageContent">
						<div class="message-attribution message-attribution--split">
							<h2 class="message-attribution-main block-textHeader" style="margin: 0">
								<a href="' . $__templater->fn('link', array('resources/update', $__vars['update'], ), true) . '" rel="nofollow">' . $__templater->escape($__vars['update']['title']) . '</a>
							</h2>
	...
	$__compilerTemp1 .= '
		...
		'confirmUrl' => $__templater->fn('link', array('resources/update/bookmark', $__vars['update'], ), false),
	...
	$__finalCompiled .= '
								<li>
									<a href="' . $__templater->fn('link', array('resources/update', $__vars['update'], ), true) . '" rel="nofollow">
										' . $__templater->fn('date_dynamic', array($__vars['update']['post_date'], array(
	))) . '
									</a>
								</li>
							</ul>
	...
	$__finalCompiled .= '
						...
						<div class="reactionsBar js-reactionsList ' . ($__vars['update']['reactions'] ? 'is-active' : '') . '">
							' . $__templater->fn('reactions', array($__vars['update'], 'resources/update/reactions', array())) . '
						</div>
	...
	if (($__vars['update']['message_state'] == 'deleted') AND $__templater->method($__vars['update'], 'canUndelete', array())) {
		$__compilerTemp4 .= '
												<a href="' . $__templater->fn('link', array('resources/update/undelete', $__vars['update'], ), true) . '" data-xf-click="overlay"
