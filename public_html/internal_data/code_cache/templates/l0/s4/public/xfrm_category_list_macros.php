...
'simple_category_list_item' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
			<a href="' . $__templater->fn('link', array('resources/categories', $__vars['category'], ), true) . '" class="categoryList-link' . ($__vars['isSelected'] ? ' is-selected' : '') . '">
...
'category' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
				<h3 class="node-title">
					<a href="' . $__templater->fn('link', array('resources/categories', $__vars['category'], ), true) . '" data-xf-init="' . (($__vars['descriptionDisplay'] == 'tooltip') ? 'element-tooltip' : '') . '" data-shortcut="node-description">' . $__templater->escape($__vars['category']['title']) . '</a>
				</h3>
				';
	...
	if ($__vars['extras']['last_update']) {
		$__finalCompiled .= '
					<div class="node-extra-row"><a href="' . $__templater->fn('link', array('resources', array('resource_id' => $__vars['extras']['last_resource_id'], ), ), true) . '" class="node-extra-title" title="' . $__templater->escape($__vars['extras']['last_resource_title']) . '">' . $__templater->escape($__vars['extras']['last_resource_title']) . '</a></div>
					<div class="node-extra-row">
						' . $__templater->fn('date_dynamic', array($__vars['extras']['last_update'], array(
