...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= '
            <a class="blockLink rippleButton" href="' . $__templater->fn('link', array('forums', ), true) . '">' . 'Forums' . '</a>
            ';
	if ($__templater->method($__vars['xf']['visitor'], 'canUseContactForm', array())) {
		...
		if ($__vars['xf']['options']['contactUrl']['type'] == 'default') {
			$__finalCompiled .= '
                    <a class="blockLink rippleButton" href="' . $__templater->fn('link', array('misc/contact', ), true) . '" data-xf-click="overlay">' . 'Contact us' . '</a>
                ';
