<?php
// FROM HASH: 82ad58d9545914fe324a91583ebea7f1
return array('macros' => array('head' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
	if ($__templater->fn('property', array('uix_iconFontFamily', ), false) == 'material') {
		$__finalCompiled .= '
		';
	...
	if ($__templater->fn('property', array('uix_googleFonts', ), false)) {
		$__finalCompiled .= '
		<link href=\'//fonts.googleapis.com/css?family=' . $__templater->fn('property', array('uix_googleFonts', ), true) . '\' rel=\'stylesheet\' type=\'text/css\'>
	';
	}
	$__finalCompiled .= '
	';
...
'body' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
	$__templater->includeJs(array(
		'src' => 'themehouse/' . $__templater->fn('property', array('uix_jsPath', ), false) . '/vendor/hover-intent/jquery.hoverIntent.js',
	...
	if ($__templater->fn('property', array('uix_backstretch', ), false)) {
		...
		';
		$__templater->includeJs(array(
			'src' => 'themehouse/' . $__templater->fn('property', array('uix_jsPath', ), false) . '/vendor/backstretch/jquery.backstretch.js',
