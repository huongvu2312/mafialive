...
/*$(function()
{
  ...
  'option_explain.shortcodeToEmoji' => 'If enabled common <code>:short_code:</code> will be converted to emoji and, where supported, we will display suggestions as you type.<br />
<br />
<b>Note:</b> In the event that any smilie replacement text overlaps with Emoji short code, it will be replaced with an Emoji on save.',
