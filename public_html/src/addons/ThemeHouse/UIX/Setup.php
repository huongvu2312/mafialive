...
class Setup extends AbstractSetup
{
    ...
    public function upgrade2010051Step1()
    {
        ...
        $schemaManager = $this->schemaManager();
        $schemaManager->alterTable('xf_user_option', function (Alter $table) use ($sidebarCollapseDefault, $sidebarNavCollapseDefault) {
    ...
    public function upgrade2010091Step1()
    {
        ...
        $this->schemaManager()->alterTable('xf_user_option', function(Alter $table) use ($columns, $sidebarCollapseDefault, $sidebarNavCollapseDefault) {
